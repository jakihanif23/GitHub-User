...
var listsfollowing = ArrayList<Data>()
class FollowingAdapter(list: ArrayList<Data>): RecyclerView.Adapter<FollowingAdapter.DataHolder>() {
        ...
        holder.itemView.setOnClickListener{
            ...
            context.startActivity(
                Intent(context, DetailActivity::class.java).putExtra(
                    DetailActivity.EXTRA_MYDATA, b))
        }
    }

    override fun getItemCount(): Int = listsfollowing.size
